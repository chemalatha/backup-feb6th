...
public class AESCheckUserCredentialsExist {
	public static String checkIfUserCredentialsExist(Context context,SharedPreferences sharedPref) throws Exception {
